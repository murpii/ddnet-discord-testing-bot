...
from utils.conn import ddnet_upload, ddnet_enabled, UploadTooLargeError
from utils.misc import maybe_coroutine

log = logging.getLogger("mt")

TESTLOG_PAGE = "https://ddnet.org/testlogs/show/"
...
async def archive_testlog(bot, testlog: TestLog, *, output_dir: str, upload: bool = False) -> bool:
    ...
    if upload and not failed and ddnet_enabled(config):
